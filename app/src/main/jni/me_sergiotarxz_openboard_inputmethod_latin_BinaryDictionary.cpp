...
static const JNINativeMethod sMethods[] = {
    ...
    },
    {
        ...
        const_cast<char *>(
                "(J[Lme/sergiotarxz/openboard/inputmethod/latin/utils/WordInputEventForPersonalization;I)I"),
...
int register_BinaryDictionary(JNIEnv *env) {
    const char *const kClassPathName = "me/sergiotarxz/openboard/inputmethod/latin/BinaryDictionary";
